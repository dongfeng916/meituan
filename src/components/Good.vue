<template>
    <div @click.stop="gotoDetail(good.goodId)" class="ub-box z-padding-v-10-px z-border-bottom-1-eee">
        <img :src="good.img" class="card-img">
        <div class="z-padding-h-10-px ub-box ub-col">
            ...
            <p class="ub-flex-1 ub-box ub-ver ub-between ub-flex-end">
                <span class="z-font-size-16" style="color:#06clae">{{good.price}}元</span>
