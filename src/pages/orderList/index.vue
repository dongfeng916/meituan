<template>
  <div class="container ub-box">
    <div class="z-width-100-percent ub-col">
      <div @click.stop="$openWin('pages/orderDetail/main')" v-for="(val,idx) in 12" :key="idx" class="order z-width-100-percent ub-box z-box-sizing-border">
        <img :src="order.img" class="z-img-cover">
