  ...
  <div class="container ub-box ub-col">
    <div class="ub-box z-padding-all-10-px" style="background:#fff">
      <div class="ub-box ub-ver">
        <img :src="userInfo.avatarUrl" class="head-img" mode="aspectFill">
      </div>
      <div class="ub-flex-1 z-font-size-18 z-color-333 ub-box ub-ver-v z-padding-h-10-px">
      ...
      <div class="z-font-size-18 z-color-333 ub-box ub-ver-v">
        <div @click.stop="exitLogin()" class="exitBtn ub-box ub-ver z-font-size-14">退出</div>
      </div>
    </div>
    <div class="ub-box ub-col z-margin-top-10-px" style="background:#fff">
      <div @click.stop="gotoOrderList()" class="z-padding-all-10-px ub-box ub-between" style="border-bottom:1px solid #eee">
      ...
      <div class="z-padding-all-10-px ub-box ub-between" style="border-bottom:1px solid #eee">
        <p class="ub-box ub-ver">
          <i class="iconfont icon-hongbao" style="color:#ff5722;font-size:20px"></i>
          <span class="z-font-size-15 z-color-666 z-padding-h-10-px">我的券包</span>
        </p>
        <p class="ub-box ub-ver">
          <i class="iconfont icon-xiayiyeqianjinchakangengduo z-font-size-14 z-color-888"></i>
        </p>
      ...
      <div class="z-padding-all-10-px ub-box ub-between" style="border-bottom:1px solid #eee">
        <p class="ub-box ub-ver">
          <i class="iconfont icon-caiwu" style="color:#ff5722;font-size:20px"></i>
      ...
      <div @click.stop="clickCall()" class="z-padding-all-10-px ub-box ub-between" style="border-bottom:1px solid #eee">
        <p class="ub-box ub-ver">
          <i class="iconfont icon-dianhua" style="color:#06c1ae;font-size:20px"></i>
          <span class="z-font-size-15 z-color-666 z-padding-h-10-px">客户电话：10107888</span>
        </p>
        <p class="ub-box ub-ver">
          <i class="iconfont icon-xiayiyeqianjinchakangengduo z-font-size-14 z-color-888"></i>
        </p>
